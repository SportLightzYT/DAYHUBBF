...
repeat wait()
	if game.Players.LocalPlayer.Team == nil and game:GetService("Players")["LocalPlayer"].PlayerGui.Main.ChooseTeam.Visible == true then
		...
		elseif _G.ChooseTeam == "Marine" then
...
_G.Color = Color3.fromRGB(255, 255, 51)
...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Day Hub Blox Fruits Premium') then
        makefolder('Day Hub Blox Fruits Premium')
    end
    if not _G.Dis and not isfile('Day Hub Blox Fruits Premium/'..Name..'.json') then
        writefile('Day Hub Blox Fruits Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Day Hub Blox Fruits Premium') and isfile('Day Hub Blox Fruits Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Day Hub Blox Fruits Premium/'..Name..'.json'))
		...
		function CheckLevel()
			...
			if Old_World then
				...
				elseif Lv == 150 or Lv <= 174 or SelectMonster == "Sky Bandit [Lv. 150]" then -- Sky Bandit
					...
					CFrameMon = CFrame.new(-4968.58740234375, 278.06646728515625, -2799.314697265625)
				elseif Lv == 175 or Lv <= 249 or SelectMonster == "Dark Master [Lv. 175]" then -- Dark Master
					...
					NameMon = "Dark Master"
					CFrameQ = CFrame.new(-4842.1372070313, 717.69543457031, -2623.0483398438)
					CFrameMon = CFrame.new(-5245.451171875, 388.6519470214844, -2155.7314453125)
			...
			if Three_World then
				...
				elseif Lv == 2250 or Lv <= 2375 or SelectMonster == "Cake Guard [Lv. 2225]" then
				...
				elseif Lv == 2250 or Lv <= 2275 or SelectMonster == "Baking Staff [Lv. 2250]" then 
					...
					CFrameQ = CFrame.new(-1927.7203369140625, 37.798133850097656, -12842.58984375)
				...
				elseif Lv == 2275 or Lv <= 2300 or SelectMonster == "Head Baker [Lv. 2275]" then
					...
					QuestLv = 2
					NameMon = "Head Baker"
					CFrameMon = CFrame.new(-1927.7203369140625, 37.798133850097656, -12842.58984375)
					CFrameQ = CFrame.new(-2017.4874267578125, 36.85276412963867, -12027.53515625)
				elseif Lv == 2300 or Lv <= 2330 or SelectMonster == "Cocoa Warrior [Lv. 2300]" then 
					Ms = "Cocoa Warrior [Lv. 2300]"
					NameQuest = "ChocQuest1"
					QuestLv = 1
					NameMon = "Cocoa Warrior"
					CFrameQ = CFrame.new(231.12754821777344, 24.760038375854492, -12198.861328125)
					CFrameMon = CFrame.new(-68.01099395751953, 24.76007843017578, -12290.7548828125)
				elseif Lv == 2330 or Lv <= 2350 or SelectMonster == "Chocolate Bar Battler [Lv. 2325]" then 
					Ms = "Chocolate Bar Battler [Lv. 2325]"
					NameQuest = "ChocQuest1"
					QuestLv = 2
					NameMon = "Chocolate Bar Battler"
					CFrameQ = CFrame.new(231.12754821777344, 24.760038375854492, -12198.861328125)
					CFrameMon = CFrame.new(739.2330322265625, 24.76003646850586, -12678.966796875)
				elseif Lv == 2350 or Lv <= 2375 or SelectMonster == "Sweet Thiefs [Lv. 2350]" then 
					Ms = "Sweet Thiefs [Lv. 2350]"
...
if IKAI then
	...
	TextLabelfps.Size = UDim2.new(0, 23, 0, 23)
...
game.StarterGui:SetCore("SendNotification", {
	Title = "Day Hub Notification", 
	Text = "ฟังก์ชั่นที่มีไอคอนนี้สามารถเปิด\nพร้อมฟาร์มเวลได้",
	Icon = "http://www.roblox.com/asset/?id=9610159123",
	Duration = 8
})

local win = library:Window("Day",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
...
General_Tab:Label("Mob Aura")
General_Tab:Toggle("Mob Aura","9606294253",_G.MobAura,function(vu)
		_G.MobAura = vu
		spawn(function()
					...
					if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton [Lv. 1975]") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie [Lv. 2000]") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul [Lv. 2025]") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy [Lv. 2050]") then
						...
						for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
							if v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name == "Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]" then
								if v.Humanoid:FindFirstChild("Animator") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
									v.Humanoid.Animator:Destroy()
								end
								_G.PosMon = v.HumanoidRootPart.CFrame
								StatrMagnet = true
...
function Raid_FG()
	...
	elseif not _G.Have_Fruit then
		Text("ไม่มีผลปีศาจเหลือแล้วครับผม :)\nไม่สามารถลงดันได้")
	end
end
spawn(function()
	while wait(.5) do
							...
							if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist","Heal") == 1 then
								...
								if FG >= 6000 then
									...
									if _G.Have_Fruit then
										...
										elseif _G.Setting_table.Phoenix_Hop then
											if not UHIkx then
												Text("รอ2ชั่วโมงถึงจะซื้อชิปลงดันได้ครับผม\nฟาร์มเงินม่วงรอดีกว่า")
												UHIkx = true
											end
											_G.Phoenix_R = true
											Raid_FG()
									...
									elseif Auto_Phoenix_Awaken_Ex then
										...
										Text("กำลังฟาร์มเงินให้ถึง 1ล้าน\nเพื่อซื้อชิปลงดันฟีนิกซ์")
										wait(10)
									end
								elseif Auto_Phoenix_Awaken_Ex then
									Auto_Phoenix_Awaken_Ex = nil
...
Quest_Tab:Toggle("Auto Rainbow Haki","9606294253",_G.Auto_Rainbow_Haki,function(value)
            ...
            while wait(.1) do
                if _G.Auto_Rainbow_Haki then
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        TP2(CFrame.new(-11892.0703125, 930.57672119141, -8760.1591796875))
                    ...
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Stone") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Stone [Lv. 1550] [Boss]") then
                            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Stone [Lv. 1550] [Boss]" then
                                    ...
                                    repeat task.wait()
                                        ...
                                        TP2(v.HumanoidRootPart.CFrame * CFrame.new(5,10,7))
                                        v.HumanoidRootPart.CanCollide = false
                            ...
                            TP2(CFrame.new(-1086.11621, 38.8425903, 6768.71436, 0.0231462717, -0.592676699, 0.805107772, 2.03251839e-05, 0.805323839, 0.592835128, -0.999732077, -0.0137055516, 0.0186523199))
                        end
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Island Empress") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Island Empress [Lv. 1675] [Boss]") then
                            ...
                            TP2(CFrame.new(5713.98877, 601.922974, 202.751251, -0.101080291, -0, -0.994878292, -0, 1, -0, 0.994878292, 0, -0.101080291))
                        end
                    elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Kilo Admiral") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Kilo Admiral [Lv. 1750] [Boss]") then
                            ...
                            TP2(CFrame.new(2877.61743, 423.558685, -7207.31006, -0.989591599, -0, -0.143904909, -0, 1.00000012, -0, 0.143904924, 0, -0.989591479))
                        end
                    elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Captain Elephant") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant [Lv. 1875] [Boss]") then
                            ...
                            TP2(CFrame.new(-13485.0283, 331.709259, -8012.4873, 0.714521289, 7.98849911e-08, 0.69961375, -1.02065748e-07, 1, -9.94383065e-09, -0.69961375, -6.43015241e-08, 0.714521289))
                        end
                    elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Beautiful Pirate") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Beautiful Pirate [Lv. 1950] [Boss]") then
                            ...
                            TP2(CFrame.new(5312.3598632813, 20.141201019287, -10.158538818359))
                        end
                    else
                        TP2(CFrame.new(-11892.0703125, 930.57672119141, -8760.1591796875))
                        if (Vector3.new(-11892.0703125, 930.57672119141, -8760.1591796875) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 30 then
...
Quest_Tab:Button("Buy Chip Law",function()
local args = {
    [1] = "BlackbeardReward",
    [2] = "Microchip",
    [3] = "2"
...
Quest_Tab:Button("Start Law Raid","9606294253",function()
        if World2 then
...
Quest_Tab:Toggle("No Color Haki For Auto Tushita","9610159123",_G.Setting_table.No_Color_Haki_Tushita,function(vu)
...
Quest_Tab:Toggle("No Color Haki For Auto Dark Dagger","9610159123",_G.Setting_table.No_Color_Haki_Dark_Dagger,function(vu)
...
PvP_Tab:Toggle("Inf Ability","9606294253",true,function(inf)
		if inf == true then
			infAb()
...
PvP_Tab:Button("Join Pirates Team",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
PvP_Tab:Button("Join Marines Team",function()
...
PvP_Tab:Button("Respawn",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
        wait()
    end)
PvP_Tab:Label("No Cooldown & Infinity")
PvP_Tab:Toggle("Infinite Soru","9606294253",getgenv().InfSoru,function(value)
...
PvP_Tab:Toggle("Spectate Player","9606294253",false,function(bool)
		Sp = bool
...
Raid_Tab:Toggle("Kill Aura","9606294253",false,function(value)
		RaidsArua = value
	end)
	spawn(function()
		while wait(.1) do
...
Shop_Tab:Toggle("Auto Buy True Triple Katana","9606294253","_G.Setting_table.Auto_Buy_truetriplekatana_Sword",function()
	_G.Setting_table.Auto_Buy_truetriplekatana_Sword = vu
	Update_Setting(getgenv()['MyName'])
end)
spawn(function()
    while wait(.1) do
        pcall(function()
            if _G.Setting_table.Auto_Buy_truetriplekatana_Sword or Triple_A then
local args = {
    [1] = "MysteriousMan",
    [2] = "2"
}
...
Shop_Tab:Toggle("Keep Fruit Inventory","9606294253",_G.Setting_table.Inventory_Fruit,function(vu)
	Inventory_Fruit = vu
		...
		pcall(function()
			if Inventory_Fruit then
				...
				if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Leopard Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leopard Fruit") then
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Leopard")
					wait(1)
				end
...
Shop_Tab:Button("Race Ghoul",function()
		local args = {
			[1] = "Ectoplasm",
			[2] = "BuyCheck",
			[3] = 4
...
Shop_Tab:Button("Race Cyborg",function()
		local args = {
			[1] = "CyborgTrainer",
			[2] = "Buy"
		}
...
Shop_Tab:Label("Trade Item")
Shop_Tab:Button("Sweet Chalice",function()
    local args = {
    [1] = "SweetChaliceNpc"
}
...
Island_Tab:Label("Stop Tween")
Island_Tab:Button("Stop Tween",function(vu)
        TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
        _G.Stop_Tween = vu
    end)
Island_Tab:Label("Island")
if Old_World then

    Island_Tab:Button("Start Island", function()
    ...
    Island_Tab:Button("UnderWater City", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61191.12109375, 18.497436523438, 1561.8873291016))
    end)
    ...
    Island_Tab:Button("Sky2", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7899.6157226563, 5545.6030273438, -422.21798706055))
    end)
elseif New_World then
    ...
    Island_Tab:Button("Law Lab", function()
...
elseif Three_World  then
    ...
    Island_Tab:Button("Floating Turtle", function()
...
local locallv = Status_Tab:Label("Level")
    spawn(function()
        while wait() do
            pcall(function()
...
local localrace = Status_Tab:Label("Race")
...
local localbeli = Status_Tab:Label("Beli")
...
local localfrag = Status_Tab:Label("Fragment")
...
local localexp = Status_Tab:Label("ExP")
...
local ObservationRange = Status_Tab:Label("")
...
local localbountyhornor = Status_Tab:Label("Bounty")
...
local localDevil = Status_Tab:Label("Devil Fruit")
...
Setting_Tab:Toggle("Remove Fog","9606294253",RemoveFog,function(value)
        RemoveFog = value
